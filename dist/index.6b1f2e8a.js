...
})({"1c96M":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9b6b9ac06b1f2e8a";
"use strict";
...
},{}],"cOnGj":[function(require,module,exports) {
...
async function desk2Gen() {
    ...
    const cards = document.querySelectorAll(".card");
    for (let i of cards)i.style.display = "none";
    for (let i1 of cards){
        for (let j of JSON.parse(localStorage.getItem("desk2")))if (i1.id === j) i1.style.display = "block";
    }
    dropMenu.classList.toggle("dropdown");
}
async function desk3Gen() {
    ...
    for (let i of cards)i.style.display = "none";
    for (let i1 of cards){
        for (let j of JSON.parse(localStorage.getItem("desk3")))if (i1.id === j) i1.style.display = "block";
    }
    dropMenu.classList.toggle("dropdown");
}
...
},{"./genCards":"bKymz","./script":"dV6cC"}]},["1c96M","cOnGj"], "cOnGj", "parcelRequiread0c")

//# sourceMappingURL=index.6b1f2e8a.js.map
